...
class SendUserAddScreen extends StatefulWidget {
  final UserProvider userProvider;
  final Function(UserModel) reload;

  const SendUserAddScreen({
  ...
  @override
  State<SendUserAddScreen> createState() => _SendUserAddScreenState();
}
                        ...
                        children: [
                          ...
                          UserList(
                            ...
                            trailing: CustomButton(
                              ...
                              onPressed: () async {
                                String? error =
                                    await widget.userProvider.addSendMapUsers(
